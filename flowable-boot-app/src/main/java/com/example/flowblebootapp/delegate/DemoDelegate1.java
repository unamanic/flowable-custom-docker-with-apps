...
@Component
public class DemoDelegate1 implements JavaDelegate {
    static Logger logger = Logger.getLogger(DemoDelegate1.class.getName());

    @Override
    public void execute(DelegateExecution delegateExecution) {
        logger.info("-----------------------------------");
        logger.info("In Demo Delegate 1");
        logger.info("-----------------------------------");
        ...
        logger.info("-----------------------------------");
        logger.info("Adding Variable 'foo'");
